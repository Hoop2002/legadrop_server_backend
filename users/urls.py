...
urlpatterns = [
    ...
    path("sign_up_google", views.AuthViewSet.as_view({"post": "sign_up_google"}), name="sign_up_google"),
    path("sign_up_vk", views.AuthViewSet.as_view({"post": "sign_up_vk"}), name="sign_up_vk"),
